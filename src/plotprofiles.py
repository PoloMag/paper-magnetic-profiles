...
Create schematic figures for various magnetic and fluid profiles.

The figures are saved in the 'figures'  directory, 
sister to the directory where this script is placed.
"""
...
from loaddatasets import ROOT_DIR
...
def plot_all_profiles():
    ...
    profile_fig.savefig(FIGURES_DIR / "profiles_all.eps",dpi=800,bbox_inches="tight")
...
def plot_it_and_rc_profiles():
    ...
    profile_fig.savefig(FIGURES_DIR / "profiles_it_and_rc.eps",dpi=DPI,bbox_inches='tight')
...
def plot_it_and_rc_profiles_same_minimum():
    ...
    profile_fig.savefig(FIGURES_DIR / "profiles_it_and_rc_same_minimum.eps",dpi=DPI,bbox_inches="tight")
...
def plot_it_and_rc_profiles_same_average():
    ...
    profile_fig.savefig(FIGURES_DIR / "profiles_it_and_rc_same_average.eps",dpi=DPI,bbox_inches="tight")
...
def plot_it_profile():
    ...
    profile_fig.savefig(FIGURES_DIR / "profile_it.eps",dpi=DPI,bbox_inches="tight")
...
def plot_rc_profile():
    ...
    profile_fig.savefig(FIGURES_DIR / "profile_rc.eps",dpi=DPI,bbox_inches="tight")
...
def plot_rm_profile():
    ...
    profile_fig.savefig(FIGURES_DIR / "profile_rm.eps",dpi=DPI,bbox_inches="tight")
...
def plot_rc_and_flow_instantaneous_profiles():
    ...
    profile_fig.savefig(FIGURES_DIR / "profiles_rc_and_flow_instantaneous.eps",
...
def plot_rm_and_flow_instantaneous_profile():
    ...
    profile_fig.savefig(FIGURES_DIR / "profiles_rm_and_flow_instantaneous.eps",
    dpi=DPI,bbox_inches="tight")
