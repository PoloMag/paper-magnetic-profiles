...
Create all plots for the analysis of magnetic profiles.

The figures are saved in the 'figures'  directory, sister to the
...
from plotprofiles import FIGURES_DIR

FIG_FILE_PATH = FIGURES_DIR
PLOT_EXTENSION = ".eps"
